...
import { Productread2DataSource, Productread2Item } from './productread2-datasource';

@Component({
  selector: 'app-productread2',
  templateUrl: './productread2.component.html',
  styleUrls: ['./productread2.component.css']
})
